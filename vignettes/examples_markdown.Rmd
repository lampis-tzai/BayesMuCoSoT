...
output = BayesMuCoSoT_fit(y, x, questioned_data, known_data, background_data,background_data_id,return_jags_outputs = TRUE)

print(output$logbf)
print(output$posterior_common_model)
print(output$posterior_questioned_data_model)
print(output$posterior_known_data_model)
```

Finally you can plot the jags outputs

```{r plots1, fig.width=7,fig.height=7}
plot(output$posterior_questioned_data_model)
```

```{r plots2, fig.width=7,fig.height=7}
